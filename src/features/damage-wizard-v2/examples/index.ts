/**
 * Índice de ejemplos para componentes del Wizard v2
 * Facilita el testing y desarrollo de cada componente por separado
 */

export { WizardStepperExample } from './WizardStepperExample';
