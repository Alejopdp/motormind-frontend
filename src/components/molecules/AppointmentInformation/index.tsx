    ...
    <div className="rounded-lg bg-white p-4 shadow-md sm:p-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-5">
        ...
        <div className="flex hidden items-center gap-3 md:flex">
          <div className="rounded-md bg-blue-100 p-2">
            <UserPen className="text-primary h-4 w-4 sm:h-5 sm:w-5" />
          </div>
          <div>
        ...
        <div className="hidden items-center gap-3 md:flex">
          <div className="rounded-md bg-blue-100 p-2">
            <Calendar1 className="text-primary h-4 w-4 sm:h-5 sm:w-5" />
          </div>
          <div>
        ...
        <div className="flex items-center gap-3">
          <div className="rounded-md bg-blue-100 p-2">
            <Timer className="text-primary h-4 w-4 sm:h-5 sm:w-5" />
          </div>
          <div>
